...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_agents', type=int, default=15, help='number of agents')    
    ...
    parser.add_argument('--lr_scheduler', action='store_true', help='use learning rate scheduler', default=False)
